...
import org.les.core.log.entry.FileLog;
import org.les.core.log.entry.Log;
import org.les.core.log.entry.MemoryLog;
import org.les.core.node.config.NodeConfig;
import org.les.core.node.store.FileNodeStore;
import org.les.core.node.store.MemoryNodeStore;
import org.les.core.node.store.NodeStore;
import org.les.core.rpc.Connector;
import org.les.core.rpc.nio.NioConnector;
import org.les.core.schedule.DefaultScheduler;
import org.les.core.schedule.Scheduler;
import org.les.core.support.ListeningTaskExecutor;
...
public class NodeBuilder {
    ...
    /**
     * Log.
     * If data directory specified, {@link } will be created.
     * Default to {@link }.
     */
    ...
    private NodeContext buildContext() {
        ...
        context.setTaskExecutor(taskExecutor != null ? taskExecutor : new ListeningTaskExecutor(
                Executors.newSingleThreadExecutor(r -> new Thread(r, "org/les/core/node"))
        ));
        // TODO share monitor
